            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="m-t-25">
                            <form action="{{ route('beranda.section5.store') }}" method="POST"
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td style="max-width:200px"><img src="{{ asset('storage/'.$data->thumbnail) }}" alt="" style="max-width:100px"></td>
                                            <td style="max-width:200px">{!! $data->bodytext !!}</td>
                                            <td><button class="btn btn-primary" data-toggle="modal"
                                                    data-target="#modal_{{ $data->id }}"><i
                                                        class="anticon anticon-edit"></i></button> | <a
                                                    href="{{ route('beranda.section5.delete', $data->id) }}"
                                            ...
                                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('beranda.section5.update',$data->id) }}" method="POST"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label for="headline">Judul</label>
