                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="m-t-25" style="max-width: 700px">
                            <form action="{{ route('beranda.section3.store') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-group">
                            ...
                            <table id="data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#modal_{{ $data->id }}"><i class="anticon anticon-edit"></i></button> | <a href="{{ route('beranda.section3.delete',$data->id) }}" class="btn btn-danger" onclick="return confirm('apakah anda yakin untuk menghapus data ini?')"><i class="anticon anticon-delete"></i></a>
                                    </tr>
                                    {{-- MODAL--}}
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('beranda.section3.update',$data->id) }}" method="POST" enctype="multipart/form-data" >
                                                        @csrf
                                                        <div class="form-group">
                                                            <label for="headline">Headline</label>
